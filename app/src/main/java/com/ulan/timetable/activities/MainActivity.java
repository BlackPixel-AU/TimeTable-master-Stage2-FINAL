...
import com.ulan.timetable.SocialMediaActivity;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.schoolwebsitemenu:
                ...
                return true;
            case R.id.socialmediamenu:
                Intent socialmediamenu = new Intent(MainActivity.this, SocialMediaActivity.class);
                        startActivity(socialmediamenu);
                        return true;
            case R.id.exams:
